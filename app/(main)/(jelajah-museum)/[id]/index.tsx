...
const styles = StyleSheet.create({
  ...
  museumAddress: { fontSize: 14, textAlign: 'center', color: '#000', lineHeight: 20, paddingHorizontal: 10 },
  ...
  introText: { fontSize: 13, color: '#000', lineHeight: 18, textAlign: 'left' },
  fullDesc: { fontSize: 13, color: '#000', lineHeight: 18, textAlign: 'justify', marginBottom: 20 },
